      ...
      <div className=" lg:h-[2600px] flex items-center ">
        <div className="container mx-auto">
          <div className="  flex flex-col justify-center  items-center py-10 lg:py-0">
            ...
            <div
              className="  text-center  lg:w-[949px] lg:h-[172px]  "
              data-aos="zoom-in"
            >
              <h3 className="h3">
                A UX Case Study on Creating a Studious Environment for Students
              </h3>
              <p className="para my-3 md:my-0">
                Andrew Jonson Posted on 27th January 2021
              </p>
            </div>

            {/* image */}
            <div className=" lg:h-[477px] " data-aos="zoom-in">
              <img
            ...
            <div className=" lg:h-[1811px]  mt-5 lg:mt-0">
              <div className="container mx-auto">
                <div className=" lg:w-[840px] mx-auto md:space-y-5 space-y-3">
                  <h2 className=" h3 lg:h-[112px] text-dark_blue" data-aos="zoom-in">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  </h2>

                  <p className="para lg:h-[224px] text-gray-600 text-justify md:text-left" data-aos="zoom-in">
                  ...
                  <h3 className="h3 lg:h-[56px]" data-aos="zoom-in">
                  ...
                  <div className=" lg:h-[224px] text-gray-600 text-justify lg:text-left" data-aos="zoom-in">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                    do eiusmod tempor incididunt ut labore et dolore magna
                    aliqua. Ut enim ad minim veniam, quis nostrud exercitation
                    ullamco laboris nisi ut aliquip ex ea commodo consequat.
                  ...
                  <p className="para lg:h-[224px] text-gray-600 text-justify lg:text-left" data-aos="zoom-in">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                    do eiusmod tempor incididunt ut labore et dolore magna
                    aliqua. Ut enim ad minim veniam, quis nostrud exercitation
                    ullamco laboris nisi ut aliquip ex ea commodo consequat.
