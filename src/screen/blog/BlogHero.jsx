...
const BlogHero = () => {
  return (
    <>
     <div className=" lg:h-[857px] flex items-center my-10  ">
      <div className="container mx-auto">
        <div className="  flex  flex-col items-center">
         <div className=" text-center md:space-y-5 spac-y-3">
           <h1 className="md:h1 lg:h-[128px] lg:w-[949px]  h2 max-w-lg md:max-w-none">A UX Case Study on Creating a Studious Environment for Students</h1>
