...
const About = () => {
  return (
    <div>
      <div className="container mx-auto my-[50px] md:my-[80px] lg:my-0 lg:min-h-[500px] flex items-center">
        <AboutCard
          as={"h2"}
          label={"About us"}
      ...
      <div className="container mx-auto my-[100px]">
        <h3 className="h3 text-center">The process we follow</h3>
      ...
      <div className="w-full bg-c_gray">
        <div className="container mx-auto py-[50px] md:py-[100px]">
          <h3 className=" h3 text-center">Meet our team</h3>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-[10px] md:gap-[32px] mt-[48px]">
            {teams.map((team, id) => (
              <div className=" flex flex-col justify-center bg-white py-[20px] md:py-[40px]">
                <img src={team.img} alt="" className=" w-[90px] md:w-[160px] mx-auto" />
                <h6 className=" h6 text-center mt-[15px] md:mt-[30px] font-psemibold">{team.name}</h6>
