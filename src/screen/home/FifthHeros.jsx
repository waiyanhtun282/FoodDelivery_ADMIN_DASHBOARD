...
const FifthHeros = () => {
  return (
    ...
    <div className="container mx-auto flex lg:flex-row flex-col  justify-between  ">
      <div className="lg:w-[537px] space-y-3 text-center lg:text-left ">
      ...
      <div className="lg:w-[843px] my-3 lg:my-0">
        
          <h5 className=" lg:h5 text-center lg:text-left ">"The best agency we’ve worked with so far. They understand our product and are able to add new features with a great focus."</h5>
