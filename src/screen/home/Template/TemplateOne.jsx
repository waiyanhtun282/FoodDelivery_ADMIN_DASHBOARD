        ...
        <div className="container mx-auto">
          <div className=" flex justify-center items-center text-center ">
            ...
            <div className=" lg:w-[733px] lg:h-[224px] space-y-5">
              <div className=" lg:space-y-3 space-y-2" data-aos="zoom-in">
                <p className=" text-gray-800">What we created</p>
                <h1 className=" sm:h-[64px] sm:h1  h2">Our Work Portfolio</h1>
              </div>
              <p className="para text-gray-800 lg:h-[56px] " data-aos="zoom-in">
              ...
              <div className=" flex  justify-center gap-8 " data-aos="zoom-in">
