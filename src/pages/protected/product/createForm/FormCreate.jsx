            ...
            <form className=" my-3 ">
              <div className=" grid  grid-cols-3 gap-3">
                <input
                  type="text"
                  placeholder="Name"
                  className=" p-3 placeholder-gray-800 outline-none border  border-gray-400 rounded-md dark:bg-transparent dark:placeholder-gray-300 dark:border-gray-800 dark:text-gray-300"
                />
