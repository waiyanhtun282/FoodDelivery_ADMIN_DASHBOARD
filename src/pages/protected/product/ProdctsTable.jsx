      ...
      <tbody className=" ">
        {
          arr?.map((index,a) =>{
            return(
              <tr className="text-gray-500 bg-white border-b dark:bg-gray-900 dark:border-gray-800/50 hover:bg-gray-800/50 dark:hover:bg-gray-800/10  mx-auto" key={a}>
          <td
            scope="row"
          ...
          <td className="px-2 py-4">
            <div className="flex items-center font-psemibold  justify-center">$12434</div>
          </td>
          <td className="px-2 py-4">
